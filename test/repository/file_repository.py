...
class TestFilmFileRepository(unittest.TestCase):

    def setUp(self):
        self.__repo = FilmFileRepository("test_filme.txt")
...
class TestClientFileRepository(unittest.TestCase):

    def setUp(self):
        self.__repo = ClientFileRepository("test_clienti.txt")
        self.__repo.removeAll()
        unittest.TestCase.setUp(self)
...
class TestRentFileRepository(unittest.TestCase):
    
    def setUp(self):
        self.__repo = RentFileRepository("test_rents.txt")
        self.__repo.removeAll()
        unittest.TestCase.setUp(self)   
...
def suite_file_repository():
    ts = unittest.TestSuite()
    ts.addTests(unittest.TestLoader().loadTestsFromTestCase(TestFilmFileRepository))
    ts.addTests(unittest.TestLoader().loadTestsFromTestCase(TestClientFileRepository))
    ts.addTests(unittest.TestLoader().loadTestsFromTestCase(TestRentFileRepository))
    return ts
